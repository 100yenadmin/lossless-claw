 ...
 * OpenClaw plugin API using shared DB + engine state.
 */
function wirePluginHandlers(
  ...
  api.registerContextEngine("lossless-claw", () => shared.lcm ?? shared.waitForEngine());
  api.registerContextEngine("default", () => shared.lcm ?? shared.waitForEngine());
